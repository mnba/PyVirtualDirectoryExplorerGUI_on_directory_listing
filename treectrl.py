...
""
import wx
#from wx import * #? check this 15B26
...
class TreeCtrlPanel(wx.Panel):
	...
	def load_tree_laRfile(self):
	  ...
	  self.tree.SetItemImage(self.root, self.folderOpenIdx, wx.TreeItemIcon_Expanded)
	...
	def loadsubitems2(self,rt_item,dir):
	  ...
	  for f in ls:
	      ...
	      if self.lar.is_dir2(dir,name):
	      	...
	      	self.tree.SetItemImage(child, self.folderOpenIdx, wx.TreeItemIcon_Expanded)
	      else:
	      ...
	      for f2 in ls2: 
	        ...
	        self.tree.SetItemImage(item, self.folderOpenIdx, wx.TreeItemIcon_Expanded)
